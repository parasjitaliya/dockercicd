...
namespace ElasticLog_Implementation_Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<EmployeeProcessor>();
            services.AddScoped<ElasticLogHelper>();
            //services.AddScoped<Employee>();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "Employee", Version = "v1" });
            });
        }
